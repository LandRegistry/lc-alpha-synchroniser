...
part_cancel_again = '{"update_registration": {"part_cancelled": "Another bit", "type": "Part Cancellation"}, "registration_no": "1003", "document_id": 35, "applicant": {"address": "49 Camille Circles\r\nPort Eulah\r\nPP39 6BY", "reference": "jjj", "name": "S & H Legal Group", "key_number": "1234567"}, "registration": {"date": "2014-08-01"}}'


lc_api = RestAPI.new($LAND_CHARGES_URI)
reg1 = lc_api.post('/cancellations', part_cancel_again)
puts reg1
reg1['cancellations'].each do |can|
    create_reg_document(can['date'], can['number'])
end
